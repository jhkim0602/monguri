...
export default function Header({ title, rightElement, variant = 'default' }: HeaderProps) {
    if (variant === 'clean') {
        return (
            <header className="px-6 pt-6 pb-3 flex justify-between items-center bg-white border-b border-gray-50">
    ...
    return (
        <header className="px-6 pt-8 pb-3 flex justify-between items-center bg-white">
